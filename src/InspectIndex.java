...
public class InspectIndex {
	...
	"where options include\n" +
        "    -list-doc IDOCID\n" +
	"\t\t\tlist the contents of the document with internal externalID\n" +
	"\t\t\tIDOCID\n" +
        "    -list-docids\tlist the external docids of each document\n" +
        "    -list-edocid IDOCID\n" +
        "\t\t\tlist the external externalID of the document\n" +
        "\t\t\twith internal externalID of IDOCID\n" +
        "    -list-idocid EDOCID\n" +
        "\t\t\tlist the internal externalID of the document\n" +
        "\t\t\twith external externalID of EDOCID\n" +
	...
	for (int i=0; i < args.length; i++) {
		...
		break;
	      ...
	      System.out.println ("Internal externalID --> External externalID: " +
		...
		System.out.println ("Internal --> external externalID: " +
				    j + " --> " + d.get ("externalId"));
	      };
	...
	MultiFields.getTermPositionsEnum (reader, externalIdField, termBytes);
      iList.nextDoc();
      System.out.println ("External externalID --> Internal externalID: " +
	...
	while (fieldIterator.hasNext()) {
		...
		System.out.println ("Norm: " + norms.get (externalID));
	    }
	    */
	...
	while ((count < n) &&
	    ...
	    System.out.println ("\texternalID: " + postings.docID());
	...
	*/
	...
	System.out.println ("\nTermVector:  externalID " + docidString);
