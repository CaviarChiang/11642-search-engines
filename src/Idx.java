...
public class Idx {
    ...
    private static HashMap<String, IndexReader> openIndexReaders = new HashMap<>();
    private static HashMap<String, DocLengthStore> openDocLengthStores = new HashMap<>();
     ...
     *  @param docid The internal externalID in the lucene index.
     ...
     * @param externalId The external externalID in the Lucene index.
     * @return iternal externalID.
