...
# [new] example usage in terminal:
# perl dm.perl weight1 weight2 weight3 > output_path
# perl dm.perl 0.1 0.7 0.2 > ./test/hw2-exp5.qry
my $and_w = $ARGV[0], $near_w = $ARGV[1], $window_w = $ARGV[2];
print "718:" . formulate_query( "Controlling acid rain", "sd", $and_w, $near_w, $window_w ) . "\n";
print "719:" . formulate_query( "Cruise ship damage sea life", "sd", $and_w, $near_w, $window_w ) . "\n";
print "724:" . formulate_query( "Iran Contra", "sd", $and_w, $near_w, $window_w ) . "\n";
print "725:" . formulate_query( "Low white blood cell count", "sd", $and_w, $near_w, $window_w ) . "\n";
print "733:" . formulate_query( "Airline overbooking", "sd", $and_w, $near_w, $window_w ) . "\n";
print "734:" . formulate_query( "Recycling successes", "sd", $and_w, $near_w, $window_w ) . "\n";
print "735:" . formulate_query( "Afghan women condition", "sd", $and_w, $near_w, $window_w ) . "\n";
print "741:" . formulate_query( "Artificial Intelligence", "sd", $and_w, $near_w, $window_w ) . "\n";
print "744:" . formulate_query( "Counterfeit ID punishments", "sd", $and_w, $near_w, $window_w ) . "\n";
print "746:" . formulate_query( "Outsource job India", "sd", $and_w, $near_w, $window_w );
